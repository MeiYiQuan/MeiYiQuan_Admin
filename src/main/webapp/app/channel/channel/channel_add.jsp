                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }channel/addChannel.do'>
                           
                             <div class="form-group">
                                <label class="col-sm-3 control-label">频道名称：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name" minlength="2" value="" placeholder="频道名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="pid" name="pid"  value="" placeholder="输入频道id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
