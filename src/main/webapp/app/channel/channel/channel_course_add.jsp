                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }channel/addcourse.do'>
                             <input id="chid" name="chid" type="hidden" value="${requestScope.id }"> 
                            <div class="form-group">
                                <label class="col-sm-3 control-label">课程id：</label>
                                <div class="col-sm-8">
                                    <input id="cid" name="cid"  value="" placeholder="课程id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
