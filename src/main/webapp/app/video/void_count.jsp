                ...
                <div class="ibox">
                    ...
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/course/courseCount.do">  
                       ...
                       <%--  <span class="input-group-btn" style="font-size:15px">
                                    <a   href="${pageScope.basePath }video/nodeCount" class="btn btn-primary ">播放节点统计</a>
                        </span> --%>
                        </div>
                            ...
                            <table class="table table-hover" >
                                <tbody id="ttbody">
                                		<tr>
	                                        ...
	                                        <a href="javascript:submitFormOrder('cli')" style="font-size: 12px;]">点击量</a></td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('comm')" style="font-size: 12px;]">评论量</a> </td>
	                                       <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('shar')" style="font-size: 12px;]">转发量</a> </td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('coll')" style="font-size: 12px;]">收藏量</a></td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('pla')" style="font-size: 12px;]">视频播放量</a></td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('lik')" style="font-size: 12px;]">点赞量</a></td>
	                                       <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('timelong')" style="font-size: 12px;]">视频总长度</a> </td>
                                   	       <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('coidsize')" style="font-size: 12px;]">视频文件总大小</a> </td>
