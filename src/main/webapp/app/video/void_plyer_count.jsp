                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <table class="table table-bordered">
                            <tbody>
	                                <tr>
	                                    <td style="background-color:#f3f3f4; width:20%;">一分钟以内${list1.co}</td>
	                                    <td>                               
	                                    	${list1.co }
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;">一分钟到五分钟</td>
	                                    <td>                               
	                                    	${list2.co  }
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;">五分钟到十分钟</td>
	                                    <td>
											${list3.co  }
	                                    </td>
	                                </tr>
                                	<tr>
                               			<td style="background-color:#f3f3f4; width:20%;">十分钟到二十分钟</td>
	                                    <td>
											${list4.co  }
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;">二十分钟以上</td>
	                                    <td>                               
	                                    	${list5.co  }
	                                    </td>
