                    ...
                    <div class="ibox-content">
                        ...
                        <form  class="form-horizontal m-t" id="addForm" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="title" minlength="2" value="${requestScope.data.data.title }" placeholder="请输入名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                               <div class="form-group">
                             ...
                             <div class="form-group isfree">
                                ...
                                <div class="col-sm-8" >
                                	   <input  name="per_cost"   value="${requestScope.data.data.per_cost }" placeholder="请输入价格" type="text" class="form-control" >
                                </div>
                            </div>
                            <div class="form-group isfree">
                                <label class="col-sm-3 control-label">免费时长：</label>
                                <div class="col-sm-8" >
                                	   <input  name="freeTime"   value="${requestScope.data.data.freeTime/1000 }" placeholder="请输入免费时长" type="text" class="form-control" >
                                </div>
                            </div>
                              <div class="form-group isfree">
                            ...
                            <div class="form-group 3">
                                ...
                                <div class="col-sm-8">
                                    <input id="video_sz" name="video_sz" minlength="2" value="" placeholder="请输入视频大小,例如 1.5G或 503M" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
							...
							<div id="ossfile">你的浏览器不支持flash,Silverlight或者HTML5！</div>
								<br/>
                                  ...
                                  <input type="hidden" id="fileData" name="fileData"  value="${requestScope.data.data.video_save_url }"   />
                                  <input type="hidden" id="fileSize" name="fileSize"  value="${requestScope.data.data.video_size }"   />
                                  <input type="hidden" id="fileTolTime" name="fileTolTime"  value="${requestScope.data.data.time_long }"   />
                                   ...
                                   <div id="container">
									 ...
									 <div id="pic">
										 <video id="myVideo" controls preload="auto"  
		                        				src="${requestScope.data.data.video_save_url }">
		                        			</video>  
									 </div>
                                   <!-- <pre id="console"></pre> -->
									<p>&nbsp;</p>
                                ...
                                <label class="col-sm-3 control-label">上传封面：</label>
                                 <div class="col-sm-8" style="position: relative;" id="imgs">
                                	...
                                	<input id="video_pic_url" value="${requestScope.data.data.video_pic_url }" type="hidden" name="video_pic_url"/>
                                	<div id="pic1">
                                	<img style="max-width: 100%;margin-bottom: 10px;" src="${requestScope.data.data.video_pic_url }">
                                	</div>
                                  </div>
                            </div>
                            <div class="form-group">
        ...
        function fileUpload() {
     	...
     	function dosubmit(){
        	...
        	$.ajax({
    			type: "POST",
    			url: '../video/update.do',
    			data: { "id":"${requestScope.data.data.id }","tm":new Date().getTime(),
    				"title":$("input[name='title']").val(),
    				"remark":$("textarea[name='remark']").val(),
    				"course_id":"${requestScope.course_id}",
    				...
    				"freeTime":$("input[name='freeTime']").val(),//todo
