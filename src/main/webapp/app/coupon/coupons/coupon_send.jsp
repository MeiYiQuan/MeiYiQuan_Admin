...
<head>
    ...
    // 初始化方法
    	function huifu(){
    		$("#commentForm").attr("action","${pageScope.basePath }coupon/send.do");
            	layer.confirm("是否确定发送该优惠券",{
            		 btn: ['确定','取消']
            	},function(){
            		$("#commentForm").submit();
            	},function(){
    ...
    <link rel="shortcut icon" href="${pageScope.basePath }app/favicon.ico"> 
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
								       ...
								       <div class="col-sm-9">
								           <input type="text" value="" placeholder="用户电话"  name="phone" value=""  class="form-control" />
								       </div>
						    </div>
                            
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-3" align="center">
    ...
    function doInit(pid){
  	  $.ajax({
			...
			success:function (data){
				...
				$("#treeName").html(value);
				$("#commentForm input[name='tree']").val(value);
