                ...
                <div class="ibox float-e-margins">
                    ...
                    <c:forEach items="${requestScope.code.data.list }" var="data">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }rdcelebrity/updateHome.do'>
							
							<input type="hidden" name="id" value="${data.id }">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">推荐名称：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name"  value="${data.name}" placeholder="请输入品牌名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
									       ...
									       <div class="col-sm-9">
									        <c:if test="${data.type==1}">
									           <select class="form-control" name="type" id="type"  >
										        ...
										        <option value="2" selected="selected">名人大佬</option>
										        <option value="3">开店创业</option>
										        <option value="4">潮流技术</option>
										        </select>
										         </c:if>
									        	...
									        	<option value="1" >视频</option>
										        <option value="2">名人大佬</option>
										        <option value="3" selected="selected">开店创业</option>
										        <option value="4">潮流技术</option>
										        </select>
										        </c:if>
										        ...
										        <option value="2">名人大佬</option>
										        <option value="3">开店创业</option>
										        <option value="4" selected="selected">潮流技术</option>
										        </select>
										        </c:if>
									       </div>
									   </div>
                                    <div>
                                    <label class="col-sm-3 control-label">外网链接地址：</label>
                                		<div class="col-sm-8">
                                         <input id="relation_id" name="relation_id" value="${data.relation_id}"   placeholder="请输入关联详情id" type="text" class="form-control" required="" aria-required="true">
                                    	</div>
                                    </div>
								<div class="form-group">
								</div>
    ...
    <script>
     ...
     /*  $("#imgs img").click(function(){
        ...
        */ 
        ...
        imgPre.src = url;
        $("#pic_redirect_url").attr("value",url);
        } 
