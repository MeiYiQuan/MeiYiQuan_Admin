                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }sooncourse/addSoon.do'>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">即将上映名称：</label>
                                <div class="col-sm-8">
                                    <input id="title" name="title"  value="" placeholder="请输入名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                            		<input id="playing_time" name="playing_time" class="Wdate" type="text" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'});" value="" style="width:100px;"/> - 
                             	</div>
                            </div>
                            
                             <div class="form-group">
                                <label class="col-sm-3 control-label">视频简要介绍：</label>
                                <div class="col-sm-8">
                                <textarea id="descriptionn" name="descriptionn" style="width: 500px;" minlength="2"   rows="" cols="" required="" aria-required="true"></textarea>
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="file" id="file0" name="file0"  class="filess" onchange="preImg(this.id,'imgShow_WU_FILE_0');"  />
                                	...
                                	<input id="pic_small_url" value="" type="hidden" name="pic_small_url"/>
                                </div>
                            </div> 
                             ...
                             <!--   <div class="form-group">
                                ...
                                <input type="file" id="file1" name="file1"  class="filess" onchange="preImg1(this.id,'imgShow_WU_FILE_1');"  />
                                    <img style="width:200px; heihgt:150px;" id="imgShow_WU_FILE_1"   class="feed-photo" src="">
                                	<input id="pic_big_url" value="" type="hidden" name="pic_big_url"/>
                                </div>
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="channel_id" name="channel_id"  value="" placeholder="请输入关联频道id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div> -->
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="teacher_id" name="teacher_id"   value="" placeholder="请输入关联讲师id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-3 control-label">课程成本：</label>
                                <div class="col-sm-8">
                                    <input id="cost" name="cost"   value=""  placeholder="课程成本" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
