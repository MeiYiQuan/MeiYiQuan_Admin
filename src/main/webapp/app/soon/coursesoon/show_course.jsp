                ...
                <div class="ibox float-e-margins">
                    ...
                    <c:forEach items="${requestScope.code.data.list }" var="data">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }sooncourse/showCourse.do'>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="col-sm-3 control-label">视频上映简要介绍：</label>
                                <div class="col-sm-8">
                                <textarea id="descriptionn" name="descriptionn" style="width: 500px;" value=""></textarea>
                                </div>
                            </div>
                             
                             
                             <div class="form-group">
                                <label class="col-sm-3 control-label">上映时所属频道id：</label>
                                <div class="col-sm-8">
                                    <input id="channel_id" name="channel_id"   value="" placeholder="请输入频道id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
