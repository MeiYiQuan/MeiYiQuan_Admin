                ...
                <div class="ibox">
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                             <form id="dataForm" action="/mei_yi_quan_admin/share/shareList.do"  method="post">  
                        ...
                        <div class="project-list">
                            <table class="table table-hover" >
                                <tbody id="ttbody">
                                		<tr>
	                                        <td class="project-title" align="center">分享时间</td>
	                                       	<td class="project-title" align="center">分享人</td>
	                                       	<td class="project-title" align="center">分享内容类型</td>
	                                       	<td class="project-title" align="center">分享内容id</td>
                                       		<td class="project-title" align="center">区域</td>
	                                       				
                                   	    </tr>
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
	                                        <td class="project-title" align="center">
												<small>${data.share_time }</small>
	                                        </td>
	                                        <td class="project-title" align="center">
													<small>
													${data.username }
	                                        ...
	                                        <td class="project-title" align="center">
													...
													<small>
													<c:if test="${data.type eq '3' }">视频</c:if>
													<c:if test="${data.type eq '4' }">活动</c:if>
													</small>
	                                        </td>
	                                        <td class="project-title" align="center">
													<small>
