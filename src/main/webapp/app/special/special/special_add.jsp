                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }special/addSpecial.do'>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">精彩专题名称：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name" minlength="2" value="  " placeholder="请输入活动标题" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
							...
							<div class="form-group picture">
                                ...
                                <input type="file" id="file0" name="file0"  class="filess" onchange="preImg(this.id,'imgShow_WU_FILE_0');"  />
                                	...
                                	<input id="cover_pic_url" value="" type="hidden" name="cover_pic_url"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="introduction" name="introduction" value="" placeholder="请输入简介" class="form-control" required="" aria-required="true"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="remark" name="remark" minlength="2" value="" placeholder="请输入详情" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
