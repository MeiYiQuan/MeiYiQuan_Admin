...
<head>
    ...
    // ------------------------------------------------通用部分(开始)--------------------------------------------------------
    	...
    	function toadd(){
    		window.location.href = "${pageScope.basePath }special/toaddCourse.do?sid=${requestScope.id}";
    	}
    ...
    // 点击删除
    	function del(cid,sid){
            	...
            	layer.confirm("是否确定发送此推送吗？",{
            		...
            		window.location.href = "${pageScope.basePath }special/delCourse.do?cid="+cid+"&sid="+sid+"";
            	},function(){
                ...
                <div class="ibox">
                    ...
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/special/courseList.do"  method="post">  
                    		...
                    		课程标题：<input type="text" id="name" name="name" value="${requestScope.name }" />
                         	<br/><br/>
                            </span>
                        ...
                        <div class="project-list">
                            <table class="table table-hover" >
                                <tbody id="ttbody">
                                		<tr>
	                                        <td class="project-title" align="center">课程宣传图片</td>
	                                        <td class="project-title" align="center">课程名称</td>
	                                        <td class="project-completion" align="center" >课程简介</td>
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr id="tr${data.id }">
	                                        ...
	                                        <td class="project-completion" align="center">
	                                        	<a href="#" onclick="return del('${data.id }','${data.subject_id}')" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>删除 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
