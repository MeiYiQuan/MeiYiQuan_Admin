                       ...
                       <c:forEach items="${requestScope.code.data.list }" var="data">
                        <table class="table table-bordered">
                            <tbody>
	                                ...
	                                <tr>
	                                    <td style="background-color:#f3f3f4; width:20%;">点击量</td>
	                                    <td>
	                                     ${data.click_count } 
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;">评论量</td>
	                                    <td>
	                                     ${data.comment_count } 
	                                    </td>
	                                </tr>
                                	<tr>
                               			<td style="background-color:#f3f3f4; width:20%;">转发量</td>
	                                    <td>
	                                     ${data.share_count } 
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;">收藏量</td>
	                                    <td> ${data.collect_count }</td>
                                </tr>
                                <tr>
                               			<td style="background-color:#f3f3f4; width:20%;">投票量</td>
	                                    <td>
	                                     ${data.vote } 
	                                    </td>
