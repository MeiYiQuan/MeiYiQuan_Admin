                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <table class="table table-bordered">
                            <tbody>
	                                <tr>
	                                    <td style="background-color:#f3f3f4; width:20%;">普通用户发布求教程数量</td>
	                                    <td>                               
	                                    <a href="${pageScope.basePath }askcourse/numTongji.do?type=2&typee=0" > ${pt} </a>
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;">讲师发布求教程数量</td>
	                                    <td>
	                                    <a href="${pageScope.basePath }askcourse/numTongji.do?type=2&typee=1" > ${js} </a>
	                                    </td>
	                                </tr>
                                	<tr>
                               			<td style="background-color:#f3f3f4; width:20%;">平台发布求教程数量</td>
	                                    <td>
	                                    <a href="${pageScope.basePath }askcourse/numTongji.do?type=1&typee=0" > ${p} </a>
	                                    </td>
	                                    <td style="background-color:#f3f3f4; width:20%;"></td>
	                                    <td></td>
                                </tr>
                            </tbody>
                        </table>
