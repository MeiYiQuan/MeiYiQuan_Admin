                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <button onclick="javascript:history.go(-1);" type="button" class="btn btn-w-m btn-white btn-xs"><i class="fa fa-reply"></i>返回</button>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }banner/EditBanner.do?id=${id}'>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">名称：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name" minlength="2" value="${name}" placeholder="请输入品牌名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="file0" name="file0"  class="filess" onchange="preImg(this.id,'imgShow_WU_FILE_0');"  />
                                    <img style="width:200px; heihgt:150px;" id="imgShow_WU_FILE_0"   class="feed-photo" src="${pic_save_url }">
                                	<input id="pic_save_url" value="${pic_save_url }" type="hidden" name="pic_save_url"/>
                                </div>
                            </div>
	                                   ...
	                                   <div class="form-group">
									       ...
									       <div class="col-sm-9">
									        ...
									        <c:if test="${jump_type==0}">
									           <select class="form-control" name="jump_type" id="jump_type"  >
										        ...
										        <option value="2">活动</option>
										         ...
										         <c:if test="${jump_type==2}">
										          <select class="form-control" name="jump_type" id="jump_type"  >
									        	<option value="0">课程</option>
										        <option value="1">讲师</option>
										        <option value="2" selected="selected">活动</option>
										        </select>
										        </c:if>
									   ...
									   <!-- 
									    <div class="form-group">
									       <label class="col-sm-3 control-label">轮播图展示页面：</label>
									       <div class="col-sm-9">
									        <c:if test="${showtype==1}">
									           <select class="form-control" name="showtype" id="showtype"  >
										        <option value="1" selected="selected">首页页面</option>
										        <option value="2">发现页面</option>
										        </select>
										        </c:if>
										         <c:if test="${showtype==2}">
										         <select class="form-control" name="showtype" id="showtype"  >
										        <option value="1" >首页页面</option>
										        <option value="2" selected="selected">发现页面</option>
										        </select>
										         </c:if>
									       </div>
									   </div>
									    -->
                                    <div>
                                    <label class="col-sm-3 control-label">跳转详情id：</label>
                                		<div class="col-sm-8">
                                         <input id="jump_id" name="jump_id" value="${jump_id}" minlength="2" placeholder="请输入跳转详情id" type="text" class="form-control" required="" aria-required="true">
                                    	</div>
                                    </div>
								<div class="form-group">
								</div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="remark" name="remark"  placeholder="请输入描述" class="form-control" >${remark}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                     <div class="radio checkbox-inline">
                                         <input type="radio" name="order_num" id="order_num" value="1" <c:if test="${isTop eq 1 }">checked</c:if> >
                                         <label for="radio1">置顶</label>
                                    </div>
                                    <div class="radio checkbox-inline">
                                         <input type="radio" name="order_num" id="order_num" value="-1" <c:if test="${isTop eq 2 }">checked</c:if> >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                     <div class="radio checkbox-inline">
                                         <input type="radio" name="showtype" value="1" <c:if test="${showtype eq 1 }">checked</c:if> >
                                         <label for="radio1">首页</label>
                                    </div>
                                    <div class="radio checkbox-inline">
                                         <input type="radio" name="showtype" value="2" <c:if test="${showtype eq 2 }">checked</c:if> >
                                         <label for="radio1">发现页面</label>
                                    </div>
                                </div>
                            </div>
