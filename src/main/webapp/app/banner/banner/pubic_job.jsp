                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }message/jobUpdate.do'>
                           <input type="hidden" name="type" value="${type}">
                           <input type="hidden" name="id" value="${id}">
                             <div class="form-group">
                                <label class="col-sm-3 control-label">参数顺序：</label>
                                <div class="col-sm-8">
                                    <input id="orderInt" name="orderInt" minlength="2" value="${orderInt}" placeholder="请输入讲师id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                               <label class="col-sm-3 control-label">参数值：</label>
                                <div class="col-sm-8">
                                    <input id="job_name"  name="job_name" minlength="2" value="${job_name}" placeholder="请输入参数值" type="text" class="form-control" >
                                </div>
                            </div>
