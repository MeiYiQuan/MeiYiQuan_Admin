                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }/message/publicUpdat.do'>
                           <input type="hidden" name="type" value="${type}">
                           <input type="hidden" name="id" value="${id}">
                             <div class="form-group">
                                <label class="col-sm-3 control-label">参数名称：</label>
                                <div class="col-sm-8">
                                    <input id="title" name="title" minlength="2" value="${title}" placeholder="请输入讲师id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                          ...
                          <c:if test="${type  eq 1 }">
                              <div class="form-group">
                                ...
                                <input type="file" id="file0" name="file0"  class="filess" onchange="preImg(this.id,'imgShow_WU_FILE_0');"  />
                                    <img style="width:200px; heihgt:150px;" id="imgShow_WU_FILE_0"   class="feed-photo" src="${sys_value }">
                                	<input id="sys_valuee" value="${sys_value}" type="hidden" name="sys_valuee"/>
                                </div>
                            </div>
                           </c:if> 
                           ...
                           <c:if test="${type ne 1}">
                              <div class="form-group">
                               <label class="col-sm-3 control-label">参数值：</label>
                                <div class="col-sm-8">
                                    <input   name="sys_value" minlength="2" value="${sys_value}" placeholder="请输入参数值" type="text" class="form-control" >
                                </div>
                            </div>
                           </c:if> 
