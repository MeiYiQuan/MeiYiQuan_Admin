                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }banner/addBanner.do'>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">名称：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name" minlength="1" value="" placeholder="请输入品牌名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="file0" name="file0"  class="filess" onchange="preImg(this.id,'imgShow_WU_FILE_0');"  />
                                	...
                                	<input id="pic_save_url" value="" type="hidden" name="pic_save_url"/>
                                </div>
                            </div>
	                                   <div class="form-group">
									   ...
									   <!-- 
									    ...
									    -->
                                    <div>
                                    <label class="col-sm-3 control-label">banner跳转详情id：</label>
                                		<div class="col-sm-8">
                                         <input id="jump_id" name="jump_id" value="" minlength="" placeholder="请输入跳转详情id" type="text" class="form-control" required="" aria-required="true">
                                    	</div>
                                    </div>
								<div class="form-group">
								</div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="remark" name="remark"  placeholder="请输入描述" class="form-control" ></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                     <div class="radio checkbox-inline">
                                         <input type="radio" name="order_num" id="order_num" value="1" checked="">
