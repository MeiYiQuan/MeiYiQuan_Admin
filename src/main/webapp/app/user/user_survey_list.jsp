                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/user/getSurveyList">  
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr id="tr${data.id }">
                                		 <td class="project-title" align="center">
	                                        ...
	                                        <a href="/mei_yi_quan_admin/user/getUserSurvey?id=${data.id}" class="btn btn-white btn-sm" ><i class="fa fa-folder"></i>
	                                        		调查详情${data.surveyNum }
	                                        	</a>
