                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="${pageScope.basePath }district/getDistrictListTypeThere"  method="get">
                                ...
                                <div class="input-group" align="left">
	                                <span class="col-sm-3">
	                                   ...
	                                   <a   href="javascript:toadd('${requestScope.id }');" class="btn btn-primary ">添加</a>
	                                       <a   href="${pageScope.basePath }district/getDistrictListTypeTwo?id=${requestScope.pid }" class="btn btn-primary ">返回上一级</a>
	                           </span>
                                </div>
                            </div>
                             </form>
