                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="${pageScope.basePath }district/getDistrictListTypeOne"  method="get">
                            <div class="col-md-11">
                                <div class="input-group" align="left">
	                                <span class="col-sm-3">
                             </span>
	                                    <span class="input-group-btn" style="font-size:15px">
	                                       <a   href="javascript:toadd(1);" class="btn btn-primary ">添加</a>
	                           </span>
                                </div>
                            </div>
                             </form>
                        ...
                        <div class="project-list">
                            <table class="table table-hover" >
                                <tbody id="ttbody">
                                	...
                                	<c:forEach items="${requestScope.code.data }" var="district">
                                		<tr id="tr${district.id }">
	                                        ...
	                                        <c:if test="${district.status eq '1' }">
	                                            ...
	                                            <a href="#" class="btn btn-white btn-sm" onclick="return delAll('${district.id }')"><i class="fa fa-pencil"></i>删除 </a>
	                                       		  <a href="${pageScope.basePath }district/getDistrictListTypeTwo?id=${district.id}" class="btn btn-white btn-sm" ><i class="fa fa-pencil"></i>查看子集 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
