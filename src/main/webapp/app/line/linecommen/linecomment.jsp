                ...
                <div class="ibox">
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/active/commentlist.do"  method="post">  
                        ...
                        <div class="project-list">
                            <table class="table table-hover" >
                                <tbody id="ttbody">
                                		<tr>
	                                        <td class="project-title" align="center">线下活动名称</td>
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr>
	                                        ...
	                                        <td class="project-completion" align="center">
	                                             <a href="${pageScope.basePath }active/commentInfo.do?id=${data.id}" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>编辑 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
