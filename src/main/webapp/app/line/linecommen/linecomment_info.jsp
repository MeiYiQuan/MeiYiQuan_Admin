...
<head>
    ...
    // 初始化方法
    	function lahei(){
    		window.location.href = "${pageScope.basePath }active/reginaComent.do?id=${requestScope.topid}&topid=${requestScope.topid}";
    	}
    	function huifu(){
    		window.location.href = "${pageScope.basePath }active/blackComent.do?id=${requestScope.topid}&topid=${requestScope.topid}";
    	}
    // ------------------------------------------------通用部分(结束)--------------------------------------------------------
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }active/updateInfo.do'>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <small>
													<c:if test="${requestScope.status==2 }">正常</c:if>
													<c:if test="${requestScope.status==1 }">已被拉黑</c:if>
								</small>
                            </div>
                                		...
                                		<tr id="tr${data.id }">
	                                       ...
	                                       <td class="project-title" align="center">
	                                        ...
	                                        <td class="project-completion" align="center">
	                                            <a href="${pageScope.basePath }active/reginaComent.do?id=${data.id}&topid=${requestScope.topid}" class="btn btn-white btn-sm" ><i class="fa fa-pencil"></i>拉黑 </a>
	                                            <a href="${pageScope.basePath }active/blackComent.do?id=${data.id}&topid=${requestScope.topid}" class="btn btn-white btn-sm" ><i class="fa fa-pencil"></i>恢复 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
