                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form  class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }/active/saveJiabin.do'>
                             <input id="aid" name="aid" type="hidden" value="${requestScope.id }"> 
                           
                            <div class="form-group">
                                <label class="col-sm-3 control-label">嘉宾id：</label>
                                <div class="col-sm-8">
                                    <input id="uid" name="uid"  value="" placeholder="请输入嘉宾id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="money" name="money"  value="" placeholder="请输入出场费" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
