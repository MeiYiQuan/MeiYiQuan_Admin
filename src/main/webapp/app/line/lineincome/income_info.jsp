            ...
            <div class="col-sm-12">
                ...
                <div class="ibox">
                    ...
                    <ul class="nav nav-tabs">
                                ...
                                <li class=""><a data-toggle="tab" href="#tab-4"><i class="fa fa-briefcase"></i> 关联商品</a></li>
                            </ul>
                                		...
                                		<tr>
	                                        <td class="project-title" align="center">活动名称</td>
	                                         <td class="project-title" align="center">嘉宾名称</td>
	                                          <td class="project-title" align="center">付费金额</td>
	                                           <td class="project-title" align="center">实收金额</td>
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr id="tr${data.id }">
	                                        ...
	                                        <td class="project-completion" align="center">
	                                            <a href="${pageScope.basePath }active/infoActive.do?id=${data.id}" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>讲师嘉宾成本 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
