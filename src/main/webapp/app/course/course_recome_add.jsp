                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form  class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }/course/saveRecommend.do'>
                             <input id="cid" name="cid" type="hidden" value="${requestScope.id }"> 
                           
                            <div class="form-group">
                                <label class="col-sm-3 control-label">相关推荐课程id：</label>
                                <div class="col-sm-8">
                                    <input id="ccid" name="ccid"  value="" placeholder="请输入相关课程id" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
