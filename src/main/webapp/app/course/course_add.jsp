                    ...
                    <div class="ibox-content">
                        ...
                        <form  class="form-horizontal m-t" id="addForm" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input  name="name" minlength="2" value="" placeholder="请输入名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                             <!-- <div class="form-group">
                         	...
                         	<select id="firstCate" name="firstCate"  onchange="channellian(this,'#secondCate')">
                              	<option value="">请选择类别</option>
                            </select>
                            <select id="secondCate" name="secondCate"     onchange="channellian(this,'#thirdCate')">
                            	<option value="">请选择类别</option>
                              </select>
                            <select id="thirdCate"    name="thirdCate"  onchange="addthirdCate(this,'#thirdCate')">
                            	<option value="">请选择类别</option>
                             </select>
                            </span>
                             </div> -->
                             <div class="form-group">
                            	...
                            	<span class="col-sm-8" style="margin-top: 10px;">
                              	<input  id="teacher_id" name="teacher_id" minlength="2" value="" placeholder="请输入老师ID" type="text" class="form-control" required="" aria-required="true">
                            </span>
                             </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">一句话描述：</label>
                                <div class="col-sm-8">
                                    <input name="description" minlength="2" value="" placeholder="请输入描述" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                              <div class="form-group">
                                <label class="col-sm-3 control-label">完整描述：</label>
                                <div class="col-sm-8">
                                <textarea name="remark" style="width: 1047px;" minlength="2"   rows="" cols="" required="" aria-required="true"></textarea>
                                </div>
                            </div>
                              <div class="form-group">
 ...
 <script>
	...
	function pic_type(){
     ...
     // 新增
    	function toadd(){
    			  $.ajax({
    					url:"${pageScope.basePath }/mei_yi_quan_admin/course/add",
    					type:"POST",
    					async:false, 
    					data:{
    						...
    						"course_compaign_video_url":$("input[name='fileData']").val(),
