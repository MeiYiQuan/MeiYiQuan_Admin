                ...
                <div class="ibox">
                    ...
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/teacher/countTeacher.do">  
                                ...
                                <tbody id="ttbody">
                                		<tr>
	                                       ...
	                                       <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('ffl')" style="font-size: 12px;]">付费量</a> </td>
	                                       <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('ffje')" style="font-size: 12px;]">付费金额</a> </td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('zxl')" style="font-size: 12px;]">滞销量</a></td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('video')" style="font-size: 12px;]">视频制作量</a></td>
	                                        <td class="project-title" align="center">
	                                        <a href="javascript:submitFormOrder('fs')" style="font-size: 12px;]">粉丝量</a></td>
	                                       <td class="project-title" align="center">
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr >
	                                        ...
	                                        <td class="project-title" align="center">
												<small>${data.ffl}</small>
	                                        </td>
	                                        <td class="project-title" align="center">
												<small>${data.ffje }</small>
	                                        </td>
	                                        <td class="project-title" align="center">
													<small>
													${data.zxl }
