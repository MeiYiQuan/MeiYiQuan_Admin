                ...
                <div class="ibox">
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/teachermoney/tmList.do"  method="post">  
                    		...
                    		输入讲师名称：<input type="text" id="name" name="name" value="${requestScope.channelName }" />
                         	<br/><br/>
                            </span>
                                ...
                                <tbody id="ttbody">
                                		<tr>
	                                        <td class="project-title" align="center">讲师名称</td>
	                                       	<td class="project-title" align="center">总收益</td>
	                                       	<td class="project-title" align="center">剩余可提现金额</td>
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr >
	                                        ...
	                                        <td class="project-completion" align="center">
	                                             <a href="${pageScope.basePath }teachermoney/tmInfo.do?id=${data.id}&zong=${data.zong }" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>提现申请 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
