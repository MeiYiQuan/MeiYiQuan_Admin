        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <c:forEach items="${requestScope.adCode.data.list}" var="data">
                        <form enctype="multipart/form-data" class="form-horizontal m-t" id="commentForm" 
							method = 'post'  action = '${pageScope.basePath }message/updateAdmin.do'>
							<input type="hidden" name="id" value="${data.id}">
							
                            <div class="form-group">
                                <label class="col-sm-3 control-label">登录名称：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name"  value="${data.loginname}" placeholder="请输入登陆名称" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="password" name="password"  value="${data.loginname}" placeholder="请输入登录密码" type="text" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            ...
                            <label class="col-sm-3 control-label">选择用户管理权限：</label>
                             <div class="col-sm-8">
                         		<select id="roleid" name="roleid" onchange="getSecondCate()">
                            		...
                            		<option selected value="${data.roid}">${data.roleName}</option>	
                            	</select>
                           	 </div>
                            </div>
