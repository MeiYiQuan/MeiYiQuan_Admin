...
<head>
    ...
    function   toadd(){
    	window.location.href = "${pageScope.basePath }message/toaddd.do";
    }
    ...
    function delect(id){
   	layer.confirm("确定删除此用户吗？",{
   		...
   		window.location.href = "${pageScope.basePath }message/delAdmin.do?id="+id+"";
   	},function(){
                ...
                <div class="ibox">
                    <div id="tab-1" class="ibox-content">
                        <div  class="row m-b-sm m-t-sm">
                            <form id="dataForm" action="/mei_yi_quan_admin/message/adminList.do"  method="post">  
                    		...
                    		输入用户名：<input type="text" id="name" name="name" value="${requestScope.name }" />
                                ...
                                <tbody id="ttbody">
                                		<tr>
	                                        <td class="project-title" align="center">用户名称</td>
	                                       	<td class="project-title" align="center">用户密码</td>
	                                       	<td class="project-title" align="center">用户管理权限</td>
                                	...
                                	<c:forEach items="${requestScope.code.data.list }" var="data">
                                		<tr id="tr${data.id }">
	                                        ...
	                                        <td class="project-completion" align="center">
	                                             <a href="${pageScope.basePath }message/admininfo.do?id=${data.id}"  class="btn btn-white btn-sm"><i class="fa fa-folder"></i>编辑 </a>
	                                             <a href="${pageScope.basePath }message/quxiao.do?id=${data.id}" class="btn btn-white btn-sm"><i class="fa fa-folder"></i>取消权限 </a>
	                                             <a href="#" onclick="delect('${data.id}')"  class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 删除 </a>
	                                        </td>
                                   	    </tr>
                                	</c:forEach>
                                    </tbody>
