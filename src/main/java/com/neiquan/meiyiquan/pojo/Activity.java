package com.neiquan.meiyiquan.pojo;
...
import com.neiquan.meiyiquan.pojo.base.PO;
import com.neiquan.meiyiquan.util.Mysql;
...
public class Activity extends PO {
	...
	@Column(columnDefinition = ("varchar(1500) default '' comment '详细介绍'"))
	...
	@Column(columnDefinition = ("varchar(500) default '' comment '详细地址'"))
