...
public class Enums {
	...
	public static enum SystemCoupons{
		 ...
		 * 分享下载客户端宣传链接
		 */
		SHARE_CLIENT_URL(1,"getcoupons_share_client_url",SystemCouponsType.ONLY_ONE,"分享下载客户端宣传链接"),
		/**
		 * 用户发起求教程申请，审核通过
		 */
		USER_REQUEST_PASS(2,"getcoupons_user_request_pass",SystemCouponsType.NONE,"用户发起求教程申请，审核通过"),
		/**
		 * 分享视频
		 */
		SHARE_VIDEO(3,"getcoupons_share_video",SystemCouponsType.NONE,"分享视频"),
		/**
		 * 分享活动
		 */
		SHARE_ACTIVITY(4,"getcoupons_share_activity",SystemCouponsType.NONE,"分享活动"),
		/**
		 * 即将上映课程，点击喜欢或不喜欢
		 */
		LIKE_OR_DISLIKE(5,"getcoupons_like_or_dislike",SystemCouponsType.NONE,"即将上映课程，点击喜欢或不喜欢"),
		/**
		 * 参与线下活动支付的金额，赠送一个优惠价
		 */
		BUY_ACTIVITY(6,"getcoupons_buy_activity",SystemCouponsType.NONE,"参与线下活动支付的金额，赠送一个优惠价"),
		/**
		 * 分享课程
		 */
		SHARE_COURSE(7,"getcoupons_share_course",SystemCouponsType.NONE,"分享课程"),
		/**
		 * 分享求课程
		 */
		SHARE_REQUEST(8,"getcoupons_share_request",SystemCouponsType.NONE,"分享求课程");
		...
		private SystemCoupons(int type,String systemKey,SystemCouponsType couponType,String remark){
			this.type = type;
		...
		/**
		 * 通过key来获取有效的SystemCoupons，如果key不合法，返回null
		 * @param type
		 * @return
		 */
		public static SystemCoupons getSystemCoupons(String key){
			SystemCoupons[] cs = SystemCoupons.values();
			for(SystemCoupons c:cs){
				if(c.systemKey==key)
					return c;
